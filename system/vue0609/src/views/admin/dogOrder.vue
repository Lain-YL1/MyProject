<template>
    <div class="app-container">
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
        ...
        <el-form-item label="用户ID" prop="dogUserId">
          <el-input
            v-model="queryParams.dogUserId"
            placeholder="请输入用户ID"
            clearable
            size="small"
            @keyup.enter.native="handleQuery"
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              type="text"
              icon="el-icon-edit"
              v-if="scope.row.dogOrderStatus==1"
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-form-item label="狗ID" prop="dogId">
            <el-input v-model="form.dogId" placeholder="请输入狗ID" />
          </el-form-item>
          <el-form-item label="用户ID" prop="dogUserId">
            <el-input v-model="form.dogUserId" placeholder="请输入用户ID" />
          </el-form-item>
          <el-form-item label="狗名称" prop="dogName">
            <el-input v-model="form.dogName" placeholder="请输入狗名称" />
          </el-form-item>
          <el-form-item label="状态" prop="dogOrderStatus">
            <el-select v-model="form.dogOrderStatus" placeholder="请选择状态">
              <el-option
                v-for="dict in dict.type.sys_status"
                :key="dict.value"
                :label="dict.label"
  ...
  <script>
  import { listDogOrder, getDogOrder, delDogOrder, addDogOrder, updateDogOrder } from "@/api/system/dogOrder";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listDogOrder(this.queryParams).then(response => {
